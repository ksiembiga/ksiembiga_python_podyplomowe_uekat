...
zamowienie2 = Order(employee=jan_kowalski.first_name + jan_kowalski.last_name, student=Ambrozy_Kleks.first_name + Ambrozy_Kleks.last_name, books=historia_chorzowa.title + Niemiecki_nie_gryzie.title,
                    order_date='4-2-2026')
